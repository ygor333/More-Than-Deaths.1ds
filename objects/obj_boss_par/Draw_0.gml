...
{
    // Desenha o círculo ao redor do boss

    draw_set_color(c_yellow);  // Define a cor do círculo, ajuste conforme necessário
	
    draw_circle(x, y, circle_radius, true); // Desenha o círculo preenchido (opcional
}
